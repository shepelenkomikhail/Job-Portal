    ...
    return (
        <div className={"col-span-2 ml-2 flex flex-col"}>
            <div className={"flex w-full items-center justify-center gap-4"}>
                <Input type="text" placeholder="Search for jobs" width={"80%"} value={search}
                       svg={
                           <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="40px" fill="#6b7280">
            ...
            <div className={"ml-14 mt-2 flex"}>
                ...
                <div className={"grid grid-cols-2 gap-4 w-1/3"}>
                    <CheckBox label={"Relevance"} checked={selectedRelevanceOption} onChange={handleRelevanceChange} />
                    <CheckBox label={"Date"} checked={selectedDateOption} onChange={handleDateChange} />
                </div>
            </div>
        </div>
    );
