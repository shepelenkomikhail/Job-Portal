...
export default function JobCard({vacancy, grid}: {vacancy: VacancyInterface, grid: boolean}) {
    ...
    return (
        <button
            ...
            <button className={`w-auto h-auto flex justify-center items-center rounded-full absolute top-0 right-0 ${!grid ? "-translate-x-1/4 translate-y-1/3": "translate-x-1/3 -translate-y-1/3"}`}>
                    ...
                    <div className={"flex mt-2"}>
                        <div className={"flex flex-col items-center justify-center text-left"}>
                            <div className={"flex flex-row gap-4"}>
                                <img src={vacancy.companyLogo} className={"w-20 h-20 rounded-xl mb-2"}></img>
