    ...
    return (
        <div className={"flex flex-col justify-center gap-4"}>
            <div className={"relative"}>
                ...
                <Input type="text" placeholder="Choose industry.." value={searchTerm} onChange={handleSearchChange}
                    svg={
                ...
                {searchTerm && filteredIndustries.length > 0 && isDropdownVisible && (
                    ...
                    >
                        {filteredIndustries.map((industry, index) => (
                            <div key={index} className={`p-2 cursor-pointer ${selectedIndustries.includes(industry) ? "font-bold text-blue-800" : ""} 
